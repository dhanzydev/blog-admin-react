...
const Navbar = () => {
  const { isOpen, setIsOpen } = useContext(SidebarOpen);
            ...
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                ...
                <div
                  ...
                  } my-4 text-base list-none divide-y rounded shadow bg-gray-700 divide-gray-600 absolute top-10 right-0 w-48 sm:w-56"
                  id="dropdown-user`}
                >
